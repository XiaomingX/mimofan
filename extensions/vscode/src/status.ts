...
export class RuntimeStatusView implements vscode.WebviewViewProvider {
  public static readonly viewType = "mimofan.runtimeStatus";
  ...
  resolveWebviewView(view: vscode.WebviewView): void {
    ...
    view.webview.onDidReceiveMessage((message: { command?: string }) => {
      if (message.command === "check") {
        ...
        void vscode.commands.executeCommand("mimofan.startRuntime");
      } else if (message.command === "terminal") {
        void vscode.commands.executeCommand("mimofan.openTerminal");
      } else if (message.command === "threads") {
        void vscode.commands.executeCommand("mimofan.refreshAgentView");
      } else if (message.command === "snapshots") {
        void vscode.commands.executeCommand("mimofan.refreshSnapshots");
      }
    });
    this.render();
  }
...
<body>
  ...
  <button data-command="terminal">Open Mimofan Terminal</button>
