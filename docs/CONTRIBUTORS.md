...
mimofan is built in the open with a growing community of contributors. Every
...
[GitHub contributors page](https://github.com/XiaomingX/mimofan/graphs/contributors),
[`AUTHOR_MAP`](https://github.com/XiaomingX/mimofan/blob/main/.github/AUTHOR_MAP),
...
- **[OpenWarp](https://github.com/zerx-lab/warp)** — for prioritizing mimofan support and collaborating on a better terminal-agent experience.
...
- **[nightt5879](https://github.com/nightt5879)** — keep the onboarding marker in
  the mimofan home view (#3302) and branch-hygiene check hardening (#3348)
...
sibling), added TOML comment preservation and the mimofan-only skill discovery
...
- **[nightt5879](https://github.com/nightt5879)** — mimofan-only skill discovery
  gate (`[skills].scan_mimofan_only`) ignoring cross-tool directories (#3296) and
...
- **[xyuai](https://github.com/xyuai)** — canonical mimofan settings path,
...
- **[mac119](https://github.com/mac119)** and **[leo119](https://github.com/leo119)** — `mimofan update` command documentation (#838, #917)
...
- **[zlh124](https://github.com/zlh124)** — WSL2/headless startup report, clipboard-init fix, mimofan tab-title polish, localized context-menu labels, and approval-dialog fixes (#1772, #1773, #2319, #2320, #2325)
...
- **[xin1104](https://github.com/xin1104)** — Homebrew mimofan binary install (#2105)
...
- **[cy2311](https://github.com/cy2311)** — Windows `.bat` launcher for mimofan (#1861)
