...
**Related EPIC:** [#2870](https://github.com/XiaomingX/mimofan/issues/2870)
**Related issue:** [#2791](https://github.com/XiaomingX/mimofan/issues/2791)
...
- `cargo fmt --all -- --check`
- `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo check -p mimofan`
- `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo test -p mimofan commands::`
- `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo test -p mimofan command_palette`
- `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo test -p mimofan slash_completion`
- `git diff --check`
```
...
| `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo check -p mimofan` | Pass |
| `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo test -p mimofan commands::` | Pass: 456 command tests |
| `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo test -p mimofan command_palette` | Pass: 18 tests |
| `CARGO_TARGET_DIR=/tmp/mimofan-hunter-target cargo test -p mimofan slash_completion` | Pass: 17 tests |
| `git diff --check` | Pass |
