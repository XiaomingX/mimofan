...
GitHub-stewardship and release-QA workflows for maintaining mimo-tui, codified as
`SKILL.md` skills (same format Claude Code and mimo-tui both load). They encode the
...
- **mimo-tui:** copy into mimo-tui's `skills_dir` (e.g. `~/.mimo-tui/skills/`), or bundle
