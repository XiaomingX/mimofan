...
GitHub-stewardship and release-QA workflows for maintaining mimofan, codified as
`SKILL.md` skills (same format Claude Code and mimofan both load). They encode the
...
- **mimofan:** copy into mimofan's `skills_dir` (e.g. `~/.mimofan/skills/`), or bundle
