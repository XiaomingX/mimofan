...
All file:line citations are against the verified tree at the current mimo-tui
...
mimo-tui ships a large native tool surface. The first-turn *active* partition
