...
Settings written this way persist to `~/.mimofan/settings.toml` on new
...
* If you find a UI surface that still produces motion when
  ...
  [`PRIOR: Screen-reader / accessibility flag`](https://github.com/XiaomingX/mimofan/issues/450)
  with a screenshot or terminal recording.

## Related issues / history

* [#450](https://github.com/XiaomingX/mimofan/issues/450) —
  documenting the existing flag, adding the `NO_ANIMATIONS`
  startup overlay, and writing this page.
* [#449](https://github.com/XiaomingX/mimofan/issues/449) —
