...
function glibcCompatibilityMessage(required, host) {
  ...
  return [
    `Prebuilt Mimofan Linux binaries require GLIBC_${formatVersion(required)}, but ${hostLine}`,
    "",
    ...
    buildFromSourceHint(),
    "",
    "Set MIMOFAN_SKIP_GLIBC_CHECK=1 to bypass this check at your own risk.",
  ].join("\n");
}
