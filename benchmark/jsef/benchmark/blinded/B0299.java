...
public class STR1_DoubleEvaluation_By {
    ...
    static String renderBy(String template) throws Exception {
    ...
    static void stageABy(String tpl) throws Exception {
        ScriptEngine engine = new ScriptEngineManager().getEngineByName("js");
        
        Object first = engine.eval(tpl);               // 阶段 A：单次求值
        STR1_DoubleEvaluation_By.stageContext = String.valueOf(first);
    }
    ...
    static String stageCBy() throws Exception {
