 ...
 *
 * 修复要点（对照 XxeWrongFactoryBy.java）：加固设于用于解析的同一实例。
 */
public class XxeWrongFactoryBx {
    ...
    public static void main(String[] args) throws Exception {
        new XxeWrongFactoryBx().parse("<!DOCTYPE x [<!ENTITY xxe SYSTEM \"file:///etc/passwd\">]><x/>".getBytes());
    }
}
