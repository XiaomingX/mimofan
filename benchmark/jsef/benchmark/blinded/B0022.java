 ...
 *
 * JSEF-Benchmark L4 — SpelFrameworkSemantics 安全对照（BX 混淆样本）
 *
...
public class SpelFrameworkSemanticsBy {
    ...
    public void bindAndEvaluate(@RequestParam("class.module.classLoader") String paramName) {
        ...
        /*ANCHOR_1*/
        EvaluationContext byCtx = SimpleEvaluationContext.forReadWriteDataBinding().build();
        // spelParser.parseExpression(expr).getValue(byCtx) —— 受限上下文，无类加载器可达
    }

    public static void main(String[] args) {
        new SpelFrameworkSemanticsBy().bindAndEvaluate("localhost-demo");
    }
}
