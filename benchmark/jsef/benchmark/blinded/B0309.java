...
/*
 * JSEF-Benchmark L4 — PrefixCheckSsrf 安全对照（BX 混淆样本）
 *
 ...
 * CWE-918 (SSRF)。
 */
public class PrefixCheckSsrfBy {
    ...
    static void open(String url) {
        System.out.println("[http-fetch-by] " + url);
    }

    public static void main(String[] args) {
        new PrefixCheckSsrfBy().fetch("https://169.254.169.254/latest/meta-data/");
    }
}
