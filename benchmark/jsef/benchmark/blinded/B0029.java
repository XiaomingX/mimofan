 ...
 * BX 版：显式禁用 DOCTYPE 声明（disallow-doctype-decl）并开启 FEATURE_SECURE_PROCESSING。
...
public class XxeByConfig {

    


    static Document byParse(String xmlInput) throws Exception {
