 ...
 *
 * 修复要点（对照 RedirectStartsWithBy.java）：解析 URL 取 host，做精确白名单匹配。
 */
public class RedirectStartsWithBx {
    ...
    public static void main(String[] args) {
        new RedirectStartsWithBx().redirect("https://trusted.example.com.evil.com/phish");
    }
}
