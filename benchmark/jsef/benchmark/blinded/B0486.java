 ...
 *
 * 修复要点（对照 DoubleDecodeTraversalBy.java）：先一次性 canonicalize 到最终形态，
 * 再统一校验，避免多次解码造成不一致。
 */
public class DoubleDecodeTraversalBx {
    ...
    public static void main(String[] args) throws Exception {
        new DoubleDecodeTraversalBx().write("%252e%252e%252f%252e%252e%252fetc%252fpasswd");
    }
}
