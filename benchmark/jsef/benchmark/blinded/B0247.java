...
public class ReflectionInjection_By {

    // 受控别名 → 固定全限定类名（allowlist）
    private static final Map<String, String> ALLOWED = Map.of(
            "greeter", "com.jsef.benchmark.bx.reflectioninjection.Greeter",
            "formatter", "com.jsef.benchmark.bx.reflectioninjection.Formatter"
    );
