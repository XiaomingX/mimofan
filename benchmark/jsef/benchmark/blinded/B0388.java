...
public class MultiStateGateBx {
    ...
    public MultiStateGateBx(ConfigService config, VersionProvider version, RoleResolver roles) {
        this.config = config;
    ...
    public static void main(String[] args) {
        ...
        new MultiStateGateBx(new ConfigService(), new VersionProvider(), new RoleResolver())
