...
const config = {
  ...
  runtimeToken: process.env.MIMOFAN_RUNTIME_TOKEN || requiredEnv("MIMOFAN_RUNTIME_TOKEN"),
  ...
  allowlist: parseList(process.env.MIMOFAN_CHAT_ALLOWLIST),
  allowUnlisted: parseBool(process.env.MIMOFAN_ALLOW_UNLISTED, false),
  threadMapPath:
