...
mimofan is a coding agent with direct access to file operations, shell execution, and the network. Security disclosures are taken seriously.
...
Check the [releases page](https://github.com/XiaomingX/mimofan/releases) for the current version.
...
- **GitHub private advisory**: [github.com/XiaomingX/mimofan/security/advisories/new](https://github.com/XiaomingX/mimofan/security/advisories/new)
...
- Theoretical ML-model injection attacks not demonstrated in the mimofan context
