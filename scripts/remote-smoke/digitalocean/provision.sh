#!/usr/bin/env bash
# EXPERIMENTAL — DigitalOcean smoke-lab provisioning for the Mimofan
...
#
# Tunables (env):
#   DROPLET_NAME    default mimofan-smoke
...
DROPLET_NAME="${DROPLET_NAME:-mimofan-smoke}"
