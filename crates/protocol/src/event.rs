...
/// [`EventFrame::UserInputRequest`] frame so headless and TUI surfaces agree
/// on the question schema.
...
pub enum EventFrame {
    ...
    /// `request_id` is generated by the runtime to correlate a later answer.
