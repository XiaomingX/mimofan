...
pub struct McpManager {
    pub configs: HashMap<String, (McpServerConfig, ToolFilter)>,
...
pub fn allowed_by_filter(name: &str, filter: &ToolFilter) -> bool {
...
pub fn parse_qualified_tool_name(value: &str) -> Result<(String, String)> {
...
pub fn parse_server_from_uri(uri: &str) -> Option<String> {
