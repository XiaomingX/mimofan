...
#[given("an offline mimofan workspace containing:")]
...
#[then("mimofan should send the user request to the mocked LLM")]
...
#[then("mimofan should send the tool result back to the mocked LLM")]
