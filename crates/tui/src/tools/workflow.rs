...
/// Exposed for integration tests (`crates/tui/tests/*`).
pub const WORKFLOW_JOURNAL_DIR: &str = ".mimofan/workflows";
...
impl WorkflowJournal {
    ...
    pub fn load(dir: &Path, run_id: &str) -> std::io::Result<Option<Self>> {
        let path = dir
