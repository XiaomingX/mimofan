...
// deepseek_alias_deprecation removed — only XiaomiMimo and Custom providers remain.
...
///
/// All providers pass any non-empty, non-control-character string through —
/// the provider API is the authority.
#[must_use]
